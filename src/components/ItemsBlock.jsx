...
import imageless from '../assets/img/imageless.jpeg';
import { setIsFavItem } from '../redux/slices/itemSlice';

const ItemsBlock = () => {

    const dispatch = useDispatch();
    const isAdded = useSelector(state => state.isFavItem);
    const items = useSelector(state => state.items);
    return (
        <div className='container_items'>
                        <div className='item_block-wrapper'>
                            {items.map((item, index) => (<div className='item_block' key={index}>
                                <div className='item_block-image-wrapper'>
                            ...
                            <div className='item_block-info-wrapper'>
                                <h4>{item.title}</h4>
